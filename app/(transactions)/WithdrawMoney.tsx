...
const WithdrawMoney = () => {
  return (
    <ScrollView className="bg-white dark:bg-n0 pt-6 h-full">
      <PageTitle title="Withdraw Money" isBgWhite={true} />
      ...
      <View
        className="pt-8 flex-row justify-between items-center gap-x-4"
        style={marginLeftRight}
      >
        <PrimaryButton
          onPress={() => router.push("/WithdrawMoneySuccessfull")}
          text="Withdraw"
        />
      </View>
    </ScrollView>
